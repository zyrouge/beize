...
class BeizeNumberValue extends BeizeNativeObjectValue {
    ...
    if (key is BeizeStringValue) {
      switch (key.value) {
        ...
        case 'toPrecisionString':
          return BeizeNativeFunctionValue.sync(
            (final BeizeCallableCall call) => BeizeStringValue(
  ...
  @override
  BeizeClassValue kClassInternal(final BeizeVM vm) => vm.globals.numberClass;
