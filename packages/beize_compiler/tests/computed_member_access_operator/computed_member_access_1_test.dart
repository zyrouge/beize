...
Future<void> main() async {
  const String title = '[Operator] Computed Member Access (1)';
  final BeizeProgramConstant program =
      await compileTestScript('computed_member_access_operator', 'computed_member_access_1.beize');
...
expectedChunk.addConstant(1, 'value');
expectedChunk.addOpCode(BeizeOpCodes.opDeclare);
expectedChunk.addConstant(3, 'property');
expectedChunk.addOpCode(BeizeOpCodes.opPop);
