...
Future<void> main() async {
  const String title = '[Operator] Bitwise NOT (1)';
  final BeizeProgramConstant program =
      await compileTestScript('bitwise_not_operator', 'bitwise_not_1.beize');
  ...
  test('$title - Bytecode', () async {
    ...
    expectedChunk.addOpCode(BeizeOpCodes.opBitwiseNot);
